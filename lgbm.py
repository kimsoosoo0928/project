...
train=pd.read_csv('./_data/energy/train.csv', encoding='cp949')
test=pd.read_csv('./_data/energy/test.csv', encoding='cp949')
submission=pd.read_csv('./_data/energy/sample_submission.csv', encoding='cp949')

print(train) # [122400 rows x 10 columns]
print(test) # [10080 rows x 9 columns]
